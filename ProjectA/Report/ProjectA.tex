...
\subfigure[Class 0]{
\label{Fig.3ROC0}
\includegraphics[width=0.4\textwidth]{3ROC0.png}}
\subfigure[Class 1]{
\label{Fig.3ROC1}
\includegraphics[width=0.4\textwidth]{3ROC1.png}}
\subfigure[Class 2]{
\label{Fig.3ROC2}
\includegraphics[width=0.4\textwidth]{3ROC2.png}}
\subfigure[Class 3]{
\label{Fig.3ROC3}
\includegraphics[width=0.4\textwidth]{3ROC3.png}}
\subfigure[Class 4]{
\label{Fig.3ROC4}
\includegraphics[width=0.4\textwidth]{3ROC4.png}}
\subfigure[Class 5]{
\label{Fig.3ROC5}
\includegraphics[width=0.4\textwidth]{3ROC5.png}}
\subfigure[Class 6]{
\label{Fig.3ROC6}
\includegraphics[width=0.4\textwidth]{3ROC6.png}}
\subfigure[Class 7]{
\label{Fig.3ROC7}
\includegraphics[width=0.4\textwidth]{3ROC7.png}}
...
\bibitem{b2} Chattopadhay, Aditya, Anirban Sarkar, Prantik Howlader, and Vineeth N. Balasubramanian. "Grad-cam++: Generalized gradient-based visual explanations for deep convolutional networks." In 2018 IEEE winter conference on applications of computer vision (WACV), pp. 839-847. IEEE, 2018. https://arxiv.org/abs/1710.11063
...
\bibitem{b5}adityac94. "adityac94/Grad_CAM_plus_plus". \textit{github}.(2021) [Online]. Available:https://github.com/adityac94/Grad_CAM_plus_plus
\bibitem{b6}Siddhantmest. "Siddhantmest/XAI-Methods-for-CNN". \textit{github}.(2021) [Online]. Available:https://github.com/Siddhantmest/XAI-Methods-for-CNN
\bibitem{b7}Cugtyt. "【论文翻译】Grad-CAM++，可视化卷积的升级". \textit{zhihu}.(2019) [Online]. Available:https://zhuanlan.zhihu.com/p/46200853
\bibitem{b8}Sakura.D. "CNN可视化Grad-CAM". \textit{zhihu}. [Online].(2020) Available:https://zhuanlan.zhihu.com/p/105373864
