...
\end{figure}
	...
	\begin{figure}[h]
		...
		\subfigure[Loss]{
			\label{Fig.1loss}
			\includegraphics[width=0.4\textwidth]{./pics/MNIST-1D/acc-valid.png}}
		\subfigure[Accuracy]{
			\label{Fig.1acc}
			\includegraphics[width=0.4\textwidth]{./pics/MNIST-1D/loss-valid.png}}
...
The first case is case 8, which has confidence score of 0.83804
\begin{figure}[h] 
    \centering
...
\begin{figure}[h] 
    ...
    \caption{Explaination Map of case 20, confidence score=0.99755} 
\end{figure}
